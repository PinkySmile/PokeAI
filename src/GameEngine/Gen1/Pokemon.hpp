...
namespace PokemonGen1
{
	...
	public:
		...
		bool useMove(const Move &move, Pokemon &target, bool second);
		...
		void attack(unsigned char moveSlot, Pokemon &target, bool second);
		...
		[[nodiscard]] unsigned char getForcedAttack() const;
