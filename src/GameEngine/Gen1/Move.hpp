...
#define CREATE_SUBSTITUTE_CHECK [](unsigned, Pokemon &owner, Pokemon &, unsigned, bool, const BattleLogger &){ \
...
\
	...
	logger(PkmnCommon::TextEvent{target.getName() + "'s " + move->getName() + " was disabled!"});\
