...
namespace PokemonGen1
{
	...
	*/
	const std::map<unsigned char, Pokemon::Base> pokemonList{
		...
		{ 0x7D, { 0x7D,  12, "BUTTERFREE",  60,  45,  50,  70,  80, TYPE_BUG,      TYPE_FLYING,   45,  160, { Bide, Confusion, Double_Edge, Double_Team, Harden, Hyper_Beam, Mega_Drain, Mimic, Poisonpowder, Psybeam, Psychic_M, Psywave, Rage, Razor_Wind, Reflect, Rest, Sleep_Powder, Solar_Beam, String_Shot, Stun_Spore, Substitute, Supersonic, Swift, Tackle, Take_Down, Teleport, Toxic, Whirlwind } } },
		...
		{ 0x41, { 0x41,  48,    "VENONAT",  60,  55,  50,  45,  40, TYPE_BUG,      TYPE_POISON,   190, 75 , { Bide, Disable, Double_Edge, Double_Team, Leech_Life, Mega_Drain, Mimic, Poisonpowder, Psybeam, Psychic_M, Psywave, Rage, Reflect, Rest, Sleep_Powder, Solar_Beam, Stun_Spore, Substitute, Tackle, Take_Down, Toxic } } },
		{ 0x77, { 0x77,  49,   "VENOMOTH",  70,  65,  60,  90,  90, TYPE_BUG,      TYPE_POISON,   75,  138, { Bide, Disable, Double_Edge, Double_Team, Hyper_Beam, Leech_Life, Mega_Drain, Mimic, Poisonpowder, Psybeam, Psychic_M, Psywave, Rage, Razor_Wind, Reflect, Rest, Sleep_Powder, Solar_Beam, Stun_Spore, Substitute, Swift, Tackle, Take_Down, Teleport, Toxic, Whirlwind } } },
		...
		{ 0x28, { 0x28, 113,    "CHANSEY", 250,   5,   5,  50, 105, TYPE_NORMAL,   TYPE_NORMAL,   30,  255, { Bide, Blizzard, Body_Slam, Bubble_Beam, Counter, Defense_Curl, Double_Edge, Double_Slap, Double_Team, Egg_Bomb, Fire_Blast, Flash, Growl, Hyper_Beam, Ice_Beam, Light_Screen, Mega_Kick, Mega_Punch, Metronome, Mimic, Minimize, Pound, Psychic_M, Psywave, Rage, Reflect, Rest, Seismic_Toss, Sing, Skull_Bash, Softboiled, Solar_Beam, Strength, Submission, Substitute, Take_Down, Teleport, Thunder, Thunder_Wave, Thunderbolt, Toxic, Tri_Attack, Water_Gun } } },
		{ 0x1E, { 0x1E, 114,    "TANGELA",  65,  55, 115,  60, 100, TYPE_GRASS,    TYPE_GRASS,    45,  166, { Absorb, Bide, Bind, Body_Slam, Constrict, Cut, Double_Edge, Double_Team, Growth, Hyper_Beam, Mega_Drain, Mimic, Poisonpowder, Rage, Rest, Skull_Bash, Slam, Sleep_Powder, Solar_Beam, Stun_Spore, Substitute, Swords_Dance, Take_Down, Toxic } } },
