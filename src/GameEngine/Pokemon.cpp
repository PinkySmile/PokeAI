...
namespace PokemonGen1
{
	...
	*/
	const std::map<unsigned char, Pokemon::Base> pokemonList{
		{ 0x99, { 0x99,   1,  "BULBASAUR",  45,  49,  49,  45,  65, TYPE_GRASS,    TYPE_POISON,   45,  64 , { Bide, Body_Slam, Cut, Double_Edge, Double_Team, Growl, Growth, Leech_Seed, Mega_Drain, Mimic, Poisonpowder, Rage, Razor_Leaf, Reflect, Rest, Sleep_Powder, Solar_Beam, Substitute, Swords_Dance, Tackle, Take_Down, Toxic, Vine_Whip } } },
		{ 0x09, { 0x09,   2,    "IVYSAUR",  60,  62,  63,  60,  80, TYPE_GRASS,    TYPE_POISON,   45,  141, { Bide, Body_Slam, Cut, Double_Edge, Double_Team, Growl, Growth, Leech_Seed, Mega_Drain, Mimic, Poisonpowder, Rage, Razor_Leaf, Reflect, Rest, Sleep_Powder, Solar_Beam, Substitute, Swords_Dance, Tackle, Take_Down, Toxic, Vine_Whip } } },
		{ 0x9A, { 0x9A,   3,   "VENUSAUR",  80,  82,  83,  80, 100, TYPE_GRASS,    TYPE_POISON,   45,  208, { Bide, Body_Slam, Cut, Double_Edge, Double_Team, Growl, Growth, Hyper_Beam, Leech_Seed, Mega_Drain, Mimic, Poisonpowder, Rage, Razor_Leaf, Reflect, Rest, Sleep_Powder, Solar_Beam, Substitute, Swords_Dance, Tackle, Take_Down, Toxic, Vine_Whip } } },
		...
		{ 0x04, { 0x04,  35,   "CLEFAIRY",  70,  45,  48,  35,  60, TYPE_NORMAL,   TYPE_NORMAL,   150, 68 , { Bide, Blizzard, Body_Slam, Bubble_Beam, Counter, Defense_Curl, Double_Edge, Doubleslap, Double_Team, Fire_Blast, Flash, Growl, Ice_Beam, Light_Screen, Mega_Kick, Mega_Punch, Metronome, Mimic, Minimize, Pound, Psychic_M, Psywave, Rage, Reflect, Rest, Seismic_Toss, Sing, Skull_Bash, Solar_Beam, Strength, Submission, Substitute, Take_Down, Teleport, Thunder, Thunder_Wave, Thunderbolt, Toxic, Tri_Attack, Water_Gun } } },
		{ 0x8E, { 0x8E,  36,   "CLEFABLE",  95,  70,  73,  60,  85, TYPE_NORMAL,   TYPE_NORMAL,   25,  129, { Bide, Blizzard, Body_Slam, Bubble_Beam, Counter, Defense_Curl, Double_Edge, Doubleslap, Double_Team, Fire_Blast, Flash, Growl, Hyper_Beam, Ice_Beam, Light_Screen, Mega_Kick, Mega_Punch, Metronome, Mimic, Minimize, Pound, Psychic_M, Psywave, Rage, Reflect, Rest, Seismic_Toss, Sing, Skull_Bash, Solar_Beam, Strength, Submission, Substitute, Take_Down, Teleport, Thunder, Thunder_Wave, Thunderbolt, Toxic, Tri_Attack, Water_Gun } } },
		...
		{ 0x64, { 0x64,  39, "JIGGLYPUFF", 115,  45,  20,  20,  25, TYPE_NORMAL,   TYPE_NORMAL,   170, 76 , { Bide, Blizzard, Body_Slam, Bubble_Beam, Counter, Defense_Curl, Disable, Double_Edge, Doubleslap, Double_Team, Fire_Blast, Flash, Ice_Beam, Mega_Kick, Mega_Punch, Mimic, Pound, Psychic_M, Psywave, Rage, Reflect, Rest, Seismic_Toss, Sing, Skull_Bash, Solar_Beam, Strength, Submission, Substitute, Take_Down, Teleport, Thunder, Thunder_Wave, Thunderbolt, Toxic, Tri_Attack, Water_Gun } } },
		{ 0x65, { 0x65,  40, "WIGGLYTUFF", 140,  70,  45,  45,  50, TYPE_NORMAL,   TYPE_NORMAL,   50,  109, { Bide, Blizzard, Body_Slam, Bubble_Beam, Counter, Defense_Curl, Disable, Double_Edge, Doubleslap, Double_Team, Fire_Blast, Flash, Hyper_Beam, Ice_Beam, Mega_Kick, Mega_Punch, Mimic, Pound, Psychic_M, Psywave, Rage, Reflect, Rest, Seismic_Toss, Sing, Skull_Bash, Solar_Beam, Strength, Submission, Substitute, Take_Down, Teleport, Thunder, Thunder_Wave, Thunderbolt, Toxic, Tri_Attack, Water_Gun } } },
		...
		{ 0xB9, { 0xB9,  43,     "ODDISH",  45,  50,  55,  30,  75, TYPE_GRASS,    TYPE_POISON,   255, 78 , { Absorb, Acid, Bide, Cut, Double_Edge, Double_Team, Mega_Drain, Mimic, Petal_Dance, Poisonpowder, Rage, Reflect, Rest, Sleep_Powder, Solar_Beam, Stun_Spore, Substitute, Swords_Dance, Take_Down, Toxic } } },
		{ 0xBA, { 0xBA,  44,      "GLOOM",  60,  65,  70,  40,  85, TYPE_GRASS,    TYPE_POISON,   120, 132, { Absorb, Acid, Bide, Cut, Double_Edge, Double_Team, Mega_Drain, Mimic, Petal_Dance, Poisonpowder, Rage, Reflect, Rest, Sleep_Powder, Solar_Beam, Stun_Spore, Substitute, Swords_Dance, Take_Down, Toxic } } },
		{ 0xBB, { 0xBB,  45,  "VILEPLUME",  75,  80,  85,  50, 100, TYPE_GRASS,    TYPE_POISON,   45,  184, { Absorb, Acid, Bide, Body_Slam, Cut, Double_Edge, Double_Team, Hyper_Beam, Mega_Drain, Mimic, Petal_Dance, Poisonpowder, Rage, Reflect, Rest, Sleep_Powder, Solar_Beam, Stun_Spore, Substitute, Swords_Dance, Take_Down, Toxic } } },
		...
		{ 0x41, { 0x41,  48,    "VENONAT",  60,  55,  50,  45,  40, TYPE_BUG,      TYPE_POISON,   190, 75 , { Bide, Confusion, Disable, Double_Edge, Double_Team, Flash, Leech_Life, Mega_Drain, Mimic, Poisonpowder, Psybeam, Psychic_M, Psywave, Rage, Reflect, Rest, Sleep_Powder, Solar_Beam, Stun_Spore, Substitute, Supersonic, Tackle, Take_Down, Toxic } } },
		{ 0x77, { 0x77,  49,   "VENOMOTH",  70,  65,  60,  90,  90, TYPE_BUG,      TYPE_POISON,   75,  138, { Bide, Confusion, Disable, Double_Edge, Double_Team, Flash, Hyper_Beam, Leech_Life, Mega_Drain, Mimic, Poisonpowder, Psybeam, Psychic_M, Psywave, Rage, Razor_Wind, Reflect, Rest, Sleep_Powder, Solar_Beam, Stun_Spore, Substitute, Supersonic, Swift, Tackle, Take_Down, Teleport, Toxic, Whirlwind } } },
		...
		{ 0x47, { 0x47,  60,    "POLIWAG",  40,  50,  40,  90,  40, TYPE_WATER,    TYPE_WATER,    255, 77 , { Amnesia, Bide, Blizzard, Body_Slam, Bubble, Bubble_Beam, Double_Edge, Doubleslap, Double_Team, Hydro_Pump, Hypnosis, Ice_Beam, Mimic, Psychic_M, Psywave, Rage, Rest, Skull_Bash, Substitute, Surf, Take_Down, Toxic, Water_Gun } } },
		{ 0x6E, { 0x6E,  61,  "POLIWHIRL",  65,  65,  65,  90,  50, TYPE_WATER,    TYPE_WATER,    120, 131, { Amnesia, Bide, Blizzard, Body_Slam, Bubble, Bubble_Beam, Counter, Double_Edge, Doubleslap, Double_Team, Earthquake, Fissure, Hydro_Pump, Hypnosis, Ice_Beam, Mega_Kick, Mega_Punch, Metronome, Mimic, Psychic_M, Psywave, Rage, Rest, Seismic_Toss, Skull_Bash, Strength, Submission, Substitute, Surf, Take_Down, Toxic, Water_Gun } } },
		{ 0x6F, { 0x6F,  62,  "POLIWRATH",  90,  85,  95,  70,  70, TYPE_WATER,    TYPE_FIGHTING, 45,  185, { Amnesia, Bide, Blizzard, Body_Slam, Bubble, Bubble_Beam, Counter, Double_Edge, Doubleslap, Double_Team, Earthquake, Fissure, Hydro_Pump, Hyper_Beam, Hypnosis, Ice_Beam, Mega_Kick, Mega_Punch, Metronome, Mimic, Psychic_M, Psywave, Rage, Rest, Seismic_Toss, Skull_Bash, Strength, Submission, Substitute, Surf, Take_Down, Toxic, Water_Gun } } },
		...
		{ 0xBC, { 0xBC,  69, "BELLSPROUT",  50,  75,  35,  40,  70, TYPE_GRASS,    TYPE_POISON,   255, 84 , { Acid, Bide, Cut, Double_Edge, Double_Team, Growth, Mega_Drain, Mimic, Poisonpowder, Rage, Razor_Leaf, Reflect, Rest, Slam, Sleep_Powder, Solar_Beam, Stun_Spore, Substitute, Swords_Dance, Take_Down, Toxic, Vine_Whip, Wrap } } },
		{ 0xBD, { 0xBD,  70, "WEEPINBELL",  65,  90,  50,  55,  85, TYPE_GRASS,    TYPE_POISON,   120, 151, { Acid, Bide, Cut, Double_Edge, Double_Team, Growth, Mega_Drain, Mimic, Poisonpowder, Rage, Razor_Leaf, Reflect, Rest, Slam, Sleep_Powder, Solar_Beam, Stun_Spore, Substitute, Swords_Dance, Take_Down, Toxic, Vine_Whip, Wrap } } },
		{ 0xBE, { 0xBE,  71, "VICTREEBEL",  80, 105,  65,  70, 100, TYPE_GRASS,    TYPE_POISON,   45,  191, { Acid, Bide, Body_Slam, Cut, Double_Edge, Double_Team, Growth, Hyper_Beam, Mega_Drain, Mimic, Poisonpowder, Rage, Razor_Leaf, Reflect, Rest, Slam, Sleep_Powder, Solar_Beam, Stun_Spore, Substitute, Swords_Dance, Take_Down, Toxic, Vine_Whip, Wrap } } },
		...
		{ 0x0C, { 0x0C, 102,  "EXEGGCUTE",  60,  40,  80,  40,  60, TYPE_GRASS,    TYPE_PSYCHIC,  90,  98 , { Barrage, Bide, Double_Edge, Double_Team, Egg_Bomb, Explosion, Hypnosis, Leech_Seed, Mimic, Poisonpowder, Psychic_M, Psywave, Rage, Reflect, Rest, Self_Destruct, Sleep_Powder, Solar_Beam, Stun_Spore, Substitute, Take_Down, Teleport, Toxic } } },
		...
		{ 0x28, { 0x28, 113,    "CHANSEY", 250,   5,   5,  50, 105, TYPE_NORMAL,   TYPE_NORMAL,   30,  255, { Bide, Blizzard, Body_Slam, Bubble_Beam, Counter, Defense_Curl, Double_Edge, Doubleslap, Double_Team, Egg_Bomb, Fire_Blast, Flash, Growl, Hyper_Beam, Ice_Beam, Light_Screen, Mega_Kick, Mega_Punch, Metronome, Mimic, Minimize, Pound, Psychic_M, Psywave, Rage, Reflect, Rest, Seismic_Toss, Sing, Skull_Bash, Softboiled, Solar_Beam, Strength, Submission, Substitute, Tail_Whip, Take_Down, Teleport, Thunder, Thunder_Wave, Thunderbolt, Toxic, Tri_Attack, Water_Gun } } },
		{ 0x1E, { 0x1E, 114,    "TANGELA",  65,  55, 115,  60, 100, TYPE_GRASS,    TYPE_GRASS,    45,  166, { Absorb, Bide, Bind, Body_Slam, Constrict, Cut, Double_Edge, Double_Team, Growth, Hyper_Beam, Mega_Drain, Mimic, Poisonpowder, Rage, Rest, Skull_Bash, Slam, Sleep_Powder, Solar_Beam, Stun_Spore, Substitute, Swords_Dance, Take_Down, Toxic, Vine_Whip } } },
		...
		{ 0x48, { 0x48, 124,       "JYNX",  65,  50,  35,  95,  95, TYPE_ICE,      TYPE_PSYCHIC,  45,  137, { Bide, Blizzard, Body_Slam, Bubble_Beam, Counter, Double_Edge, Doubleslap, Double_Team, Hyper_Beam, Ice_Beam, Ice_Punch, Lick, Lovely_Kiss, Mega_Kick, Mega_Punch, Metronome, Mimic, Pound, Psychic_M, Psywave, Rage, Reflect, Rest, Seismic_Toss, Skull_Bash, Submission, Substitute, Take_Down, Teleport, Thrash, Toxic, Water_Gun } } },
		...
		{ 0x69, { 0x69, 134,   "VAPOREON", 130,  65,  60,  65, 110, TYPE_WATER,    TYPE_WATER,    45,  196, { Acid_Armor, Aurora_Beam, Bide, Bite, Blizzard, Body_Slam, Bubble_Beam, Double_Edge, Double_Team, Focus_Energy, Growl, Haze, Hydro_Pump, Hyper_Beam, Ice_Beam, Mimic, Mist, Quick_Attack, Rage, Reflect, Rest, Sand_Attack, Skull_Bash, Substitute, Surf, Swift, Tackle, Tail_Whip, Take_Down, Toxic, Water_Gun } } },
		...
		{ 0x5B, { 0x5B, 141,   "KABUTOPS",  60, 115, 105,  80,  70, TYPE_ROCK,     TYPE_WATER,    45,  201, { Absorb, Bide, Blizzard, Body_Slam, Bubble_Beam, Cut, Double_Edge, Double_Team, Harden, Hydro_Pump, Hyper_Beam, Ice_Beam, Leer, Mega_Kick, Mimic, Rage, Razor_Wind, Reflect, Rest, Scratch, Seismic_Toss, Skull_Bash, Slash, Submission, Substitute, Surf, Swords_Dance, Take_Down, Toxic, Water_Gun } } },
