...
namespace PokemonGen1
{
	...
	*/
	const std::map<unsigned char, Pokemon::Base> pokemonList{
		...
		{ 0x28, { 0x28, 113,    "CHANSEY", 250,   5,   5,  50, 105, TYPE_NORMAL,   TYPE_NORMAL,   30,  255, { Bide, Blizzard, Body_Slam, Bubble_Beam, Counter, Defense_Curl, Double_Edge, Double_Slap, Double_Team, Egg_Bomb, Fire_Blast, Flash, Growl, Hyper_Beam, Ice_Beam, Light_Screen, Mega_Kick, Mega_Punch, Metronome, Mimic, Minimize, Pound, Psychic_M, Psywave, Rage, Reflect, Rest, Seismic_Toss, Sing, Skull_Bash, Softboiled, Solar_Beam, Strength, Submission, Substitute, Tail_Whip, Take_Down, Teleport, Thunder, Thunder_Wave, Thunderbolt, Toxic, Tri_Attack, Water_Gun } } },
