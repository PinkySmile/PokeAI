...
class Pokemon:
	...
	def change_stat(self, stat: StatsChange, nb: int, guarenteed: bool, turn: bool): ...
	def use_move(self, move: Move, target: Pokemon, second: bool): ...
	def store_damages(self, active: bool): ...
	def has_status(self, status: StatusChange): ...
	def heal(self, health: int): ...
	def take_damage(self, target: Pokemon, damage: int, ignore_substitute: bool, swap_side: bool, store_damage: bool): ...
	def use_move_slot(self, move_slot: int, target: Pokemon, second: bool): ...
